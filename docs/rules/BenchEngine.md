...
**技能**：`benchscope/skills/bs-engine-create/`（含 mock 核心方法说明、校验清单、模板、离线 `validate.sh`、打包脚本）。规范见 `benchscope/skills/Readme.md` 与 [docs/skills/BsEngineCreate.md](../skills/BsEngineCreate.md)。
