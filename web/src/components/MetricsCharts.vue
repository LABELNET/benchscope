...
const cellDefs = computed(() => [
  { key: 'output_mean', label: t('outputThroughputCol'), yUnit: 'tok/s', color: '#1677ff' },
  { key: 'peakoutput_mean', label: t('peakOutputThroughputCol'), yUnit: 'tok/s', color: '#52c41a' },
  { key: 'total_mean', label: t('totalThroughputCol'), yUnit: 'tok/s', color: '#faad14' },
  { key: 'ttft_mean', label: t('meanTtftCol'), yUnit: 'ms', color: '#1677ff' },
  { key: 'ttft_median', label: t('medianTtftCol'), yUnit: 'ms', color: '#52c41a' },
  { key: 'ttft_p99', label: t('p99TtftCol'), yUnit: 'ms', color: '#faad14' },
  { key: 'tpot_mean', label: t('meanTpotCol'), yUnit: 'ms', color: '#1677ff' },
  { key: 'tpot_median', label: t('medianTpotCol'), yUnit: 'ms', color: '#52c41a' },
  { key: 'tpot_p99', label: t('p99TpotCol'), yUnit: 'ms', color: '#faad14' },
  { key: 'itl_mean', label: t('meanItlCol'), yUnit: 'ms', color: '#1677ff' },
  { key: 'itl_median', label: t('medianItlCol'), yUnit: 'ms', color: '#52c41a' },
  { key: 'itl_p99', label: t('p99ItlCol'), yUnit: 'ms', color: '#faad14' },
])
...
function buildOption(def) {
  ...
  return {
    color: [def.color, '#52c41a', '#faad14', '#f5222d', '#13c2c2', '#722ed1', '#eb2f96', '#fa8c16'],
    tooltip: {
      trigger: 'axis',
