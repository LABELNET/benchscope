...
export PATH=/opt/maca/ompi/bin:/opt/maca/include:/opt/maca/include/mcr:/opt/maca/tools/cubridge/tools:/opt/maca/bin:/opt/maca/mxgpu_llvm/bin/:${CUCC_PATH}/tools:${CUCC_PATH}/bin:${CUDA_PATH}/bin:$PATH
